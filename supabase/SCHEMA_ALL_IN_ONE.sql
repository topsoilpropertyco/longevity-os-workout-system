...
insert into kot_incoming values
  ...
  ('zero-kot-calf-raise', 5, 'KOT Calf Raise', '25 reps — The checklist says "as prescribed"; the reps come from the Knee Ability Zero recap.', '{"reps":25}'::jsonb, 'seated-calf-raise', '[]'::jsonb, '{}'::text[], 'lower_legs', 'zero', '["Small knee bend, both feet.","Deeper knee bend as the ankle allows — heels lift slightly at the bottom.","One leg at a time.","Add a weight vest."]'::jsonb, null, false, null, null),
