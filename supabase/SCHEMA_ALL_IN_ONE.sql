...
insert into kot_incoming values
  ...
  ('zero-l-sit', 8, 'L-Sit', '60 s hold', '{"hold_s":60}'::jsonb, 'l-sit', '[]'::jsonb, '{}'::text[], 'hip_flexors_core', 'zero', '["Level 1 — alternate lifting one leg at a time, seated, for the full time.","Level 2 — same, with the hips off the floor.","Level 3 — full L-sit, both legs and hips off the floor."]'::jsonb, null, false, null, null),
  ('zero-elephant-walk', 9, 'Elephant Walk', '25 reps', '{"reps":25}'::jsonb, 'elephant-walk', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'zero', '["Hands well forward, on fingertips or a box, knees bent.","Alternate straightening one leg at a time.","Walk the hands back until the palms reach the floor in front of the toes."]'::jsonb, null, false, null, null),
  ('zero-couch-stretch', 10, 'Couch Stretch', '60 s hold, per side', '{"hold_s":60}'::jsonb, 'couch-stretch', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'zero', '["Knee down, torso upright, hands on the floor.","Hands to the front thigh.","Hands to the hips.","Shoulders to the wall."]'::jsonb, null, true, null, null),
  ('zero-standing-pigeon', 11, 'Standing Pigeon', '2 sets, 90 s hold, per side — The checklist says only "hold each side". The 2 x 90 s comes from the Knee Ability Zero recap, where the same slot is a seated piriformis stretch.', '{"hold_s":90,"sets":2}'::jsonb, 'seated-piriformis-stretch', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'zero', '[]'::jsonb, null, true, null, null),
  ...
  ('dense-chin-up', 18, 'Chin-Up', '5 min', '{"duration_min":5}'::jsonb, 'chin-up', '[{"equipment_missing":"pull_up_bar","note":"Planet Fitness has no free bar: the assisted pull-up machine.","use_slug":"assisted-standing-chin-up"},{"equipment_missing":"pull_up_bar","note":"Planet Fitness alternative: lat pulldown.","use_slug":"cable-bar-lateral-pulldown"}]'::jsonb, '{}'::text[], 'upper_body', 'dense', '["Band- or machine-assisted.","Bodyweight.","Weighted."]'::jsonb, null, false, null, null),
  ('dense-dips', 19, 'Dips', '5 min', '{"duration_min":5}'::jsonb, 'chest-dip', '[{"equipment_missing":"dip_station","note":"Neither location has a dip station: bench dips between two benches.","use_slug":"bench-dips"}]'::jsonb, '{}'::text[], 'upper_body', 'dense', '["Bench dips.","Assisted parallel-bar dips.","Full-depth bodyweight dips."]'::jsonb, null, false, null, null),
  ('dense-smith-machine-curl', 20, 'Smith Machine Curl', '5 min', '{"duration_min":5}'::jsonb, 'smith-machine-bicep-curl', '[{"equipment_missing":"smith_machine","note":"Home has no Smith machine: dumbbell curls.","use_slug":"dumbbell-bicep-curl"}]'::jsonb, '{}'::text[], 'upper_body', 'dense', '[]'::jsonb, 'https://vimeo.com/749630580', false, null, null),
  ('dense-french-press', 21, 'French Press', '5 min', '{"duration_min":5}'::jsonb, 'barbell-lying-triceps-extension-skull-crusher', '[{"equipment_missing":"ez_curl_bar","note":"Home has no EZ bar: dumbbells.","use_slug":"dumbbell-lying-triceps-extension"}]'::jsonb, '{}'::text[], 'upper_body', 'dense', '[]'::jsonb, 'https://vimeo.com/749630580', false, null, null),
  ...
  ('dense-tibialis-stretch', 24, 'Tibialis Stretch', '60 s hold', '{"hold_s":60}'::jsonb, 'posterior-tibialis-stretch', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'dense', '[]'::jsonb, null, false, null, null),
  ...
  ('dense-bench-pullover', 28, 'Bench Pullover', '5 min, 25% bodyweight', '{"duration_min":5,"pct_bodyweight":0.25}'::jsonb, 'bent-arm-dumbbell-pullover', '[]'::jsonb, '{}'::text[], 'upper_body', 'dense', '["Along the bench.","Across the bench, hips low, for the full overhead stretch.","Toward 25% bodyweight."]'::jsonb, null, false, null, null),
  ('dense-atg-shoulder-press', 29, 'ATG Shoulder Press', '5 min, 50% bodyweight', '{"duration_min":5,"pct_bodyweight":0.5}'::jsonb, 'dumbbell-shoulder-press', '[]'::jsonb, '{}'::text[], 'upper_body', 'dense', '[]'::jsonb, null, false, null, null),
  ...
  ('dense-couch-stretch', 31, 'Couch Stretch', '60 s hold, per side', '{"hold_s":60}'::jsonb, 'couch-stretch', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'dense', '["Knee down, torso upright, hands on the floor.","Hands to the front thigh.","Hands to the hips.","Shoulders to the wall."]'::jsonb, null, true, null, null),
  ('dense-piriformis-stretch', 32, 'Piriformis Stretch', '60 s hold, per side', '{"hold_s":60}'::jsonb, 'seated-piriformis-stretch', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'dense', '[]'::jsonb, null, true, null, null),
  ('dense-butterfly-stretch', 33, 'Butterfly Stretch', '60 s hold', '{"hold_s":60}'::jsonb, 'butterfly-yoga-pose', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'dense', '[]'::jsonb, null, false, null, null),
  ...
  ('dense-kot-squat-eccentric', 35, 'KOT Squat (Eccentric)', '25 reps, 5 min', '{"duration_min":5,"reps":25}'::jsonb, 'sissy-squat', '[]'::jsonb, '{}'::text[], 'knee_ability', 'dense', '["Lower to a high surface and stand back up.","Lower to a progressively lower surface.","Full range to the floor, controlled the whole way down."]'::jsonb, null, false, null, null),
  ...
  ('standards-plantar-fascia-stretch', 38, 'Plantar Fascia Stretch', '2 min', '{"duration_min":2}'::jsonb, 'foot-smr', '[]'::jsonb, '{}'::text[], 'warm_up', 'standards', '[]'::jsonb, null, false, null, null),
  ('standards-tibialis-stretch', 39, 'Tibialis Stretch', '2 min', '{"duration_min":2}'::jsonb, 'posterior-tibialis-stretch', '[]'::jsonb, '{}'::text[], 'warm_up', 'standards', '[]'::jsonb, null, false, null, null),
  ('standards-bodyweight-walk', 40, 'Bodyweight Walk', '0.25 mile', '{"distance_mi":0.25}'::jsonb, 'zone-2-steady', '[{"equipment_missing":"outdoor_route","note":"Planet Fitness or bad weather: treadmill at an easy pace.","use_slug":"walking-treadmill"}]'::jsonb, '{}'::text[], 'warm_up', 'standards', '[]'::jsonb, null, false, null, null),
  ('standards-single-leg-elevated-pike', 41, 'Single-Leg Elevated Pike', '3 sets, 60 s hold, per side', '{"hold_s":60,"sets":3}'::jsonb, 'leg-up-hamstring-stretch', '[]'::jsonb, '{}'::text[], 'hip_flexors_core', 'standards', '[]'::jsonb, null, true, null, null),
  ...
  ('standards-hanging-leg-raise', 44, 'Hanging Leg Raise', '3 × 10 reps — BENCHMARK: Toes to bar.', '{"reps":10,"sets":3}'::jsonb, 'hanging-leg-raise', '[{"equipment_missing":"pull_up_bar","note":"Planet Fitness has no free-hanging bar: the captain’s-chair or a bench leg pull-in is the substitute.","use_slug":"leg-pull-in"}]'::jsonb, '{}'::text[], 'hip_flexors_core', 'standards', '["Bent-knee raise.","Straight-leg raise to horizontal.","Toes to bar."]'::jsonb, null, false, null, null),
  ...
  ('standards-incline-dumbbell-press', 46, 'Incline Dumbbell Press', '4 × 10 reps', '{"reps":10,"sets":4}'::jsonb, 'incline-dumbbell-press', '[]'::jsonb, '{}'::text[], 'upper_body', 'standards', '[]'::jsonb, null, false, null, null),
  ...
  ('standards-pigeon', 48, 'Pigeon', '90 s hold, per side', '{"hold_s":90}'::jsonb, 'seated-piriformis-stretch', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'standards', '[]'::jsonb, null, true, null, null),
  ('standards-couch-stretch', 49, 'Couch Stretch', '90 s hold, per side', '{"hold_s":90}'::jsonb, 'couch-stretch', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'standards', '["Knee down, torso upright, hands on the floor.","Hands to the front thigh.","Hands to the hips.","Shoulders to the wall."]'::jsonb, null, true, null, null),
  ('standards-calf-stretch', 50, 'Calf Stretch', '60 s hold', '{"hold_s":60}'::jsonb, 'standing-calves-calf-stretch', '[]'::jsonb, '{}'::text[], 'warm_up', 'standards', '[]'::jsonb, null, false, null, null),
  ('standards-relaxed-lunge', 51, 'Relaxed Lunge', '3 sets, 60 s hold, per side', '{"hold_s":60,"sets":3}'::jsonb, 'kneeling-hip-flexor', '[]'::jsonb, '{}'::text[], 'knee_ability', 'standards', '[]'::jsonb, null, true, null, null),
  ...
  ('standards-butterfly-stretch', 58, 'Butterfly Stretch', '2 min', '{"duration_min":2}'::jsonb, 'butterfly-yoga-pose', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'standards', '[]'::jsonb, null, false, null, null),
  ('standards-seated-pancake', 59, 'Seated Pancake', '2 min', '{"duration_min":2}'::jsonb, 'the-straddle', '[]'::jsonb, '{}'::text[], 'mobility_cooldown', 'standards', '[]'::jsonb, null, false, null, null),
  ('standards-atg-squat', 60, 'ATG Squat', '5 × 20 reps — BENCHMARK: 25% BW, 20 reps.', '{"pct_bodyweight":0.25,"reps":20,"sets":5}'::jsonb, 'atg-squat', '[]'::jsonb, '{}'::text[], 'knee_ability', 'standards', '["Bodyweight to full depth.","Goblet-held load.","Toward 25% bodyweight for 20 reps."]'::jsonb, null, false, null, null),
  ...
  ('standards-atg-shoulder-press', 63, 'ATG Shoulder Press', '4 × 10 reps', '{"reps":10,"sets":4}'::jsonb, 'dumbbell-shoulder-press', '[]'::jsonb, '{}'::text[], 'upper_body', 'standards', '[]'::jsonb, null, false, null, null),
  ('standards-chin-up', 64, 'Chin-Up', '4 × 10 reps', '{"reps":10,"sets":4}'::jsonb, 'chin-up', '[{"equipment_missing":"pull_up_bar","note":"Planet Fitness has no free bar: the assisted pull-up machine.","use_slug":"assisted-standing-chin-up"},{"equipment_missing":"pull_up_bar","note":"Planet Fitness alternative: lat pulldown.","use_slug":"cable-bar-lateral-pulldown"}]'::jsonb, '{}'::text[], 'upper_body', 'standards', '["Band- or machine-assisted.","Bodyweight.","Weighted."]'::jsonb, null, false, null, null),
  ...
  ('standards-sissy-squat', 66, 'Sissy Squat', '5 × 20 reps', '{"reps":20,"sets":5}'::jsonb, 'sissy-squat', '[]'::jsonb, '{}'::text[], 'knee_ability', 'standards', '["One-arm assisted.","Free-standing.","Loaded."]'::jsonb, null, false, null, null),
  ('standards-l-sit', 67, 'L-Sit', '3 sets, 15 s hold', '{"hold_s":15,"sets":3}'::jsonb, 'l-sit', '[]'::jsonb, '{}'::text[], 'hip_flexors_core', 'standards', '["Level 1 — alternate lifting one leg at a time, seated, for the full time.","Level 2 — same, with the hips off the floor.","Level 3 — full L-sit, both legs and hips off the floor."]'::jsonb, null, false, null, null),
  ('standards-bench-pullover', 68, 'Bench Pullover', '4 × 10 reps — BENCHMARK: 25% BW.', '{"pct_bodyweight":0.25,"reps":10,"sets":4}'::jsonb, 'bent-arm-dumbbell-pullover', '[]'::jsonb, '{}'::text[], 'upper_body', 'standards', '["Along the bench.","Across the bench, hips low, for the full overhead stretch.","Toward 25% bodyweight."]'::jsonb, null, false, null, null),
  ('standards-trap-raise', 69, 'Trap Raise', '4 × 10 reps', '{"reps":10,"sets":4}'::jsonb, 'dumbbell-shrug', '[]'::jsonb, '{}'::text[], 'upper_body', 'standards', '[]'::jsonb, null, false, null, null);
